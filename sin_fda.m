...
f0=2e9; %载波中心频率
 delta_f=3000; %频率偏移
% Delta_f=delta_f*sin((0:M-1)*pi/(M-1));%阵列频偏设置
c=3e8;        %光速
lamda=c/f0;  %波长
d=lamda/2;    %阵元间距
D=d*(0:M-1);  %阵列距离设置
...
% %% -----sin_FDA时间角度维波束方向图     在r0,theta0,t0=0.2ms处存在目标
...
% axis tight; axis xy;
% title('正弦频偏-FDA时间角度维波束方向图');
% colorbar;
% 
% 
% 
% 
% %% -----sin__FDA时间距离维波束方向图     在r0,theta0,t0=0.2ms处存在目标
